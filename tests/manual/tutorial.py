"""Manual API demonstration; this is not an automated test."""
...
mrspace = Image(screen, str(REPO_ROOT / 'images' / 'featuredspace_logo.png'),
...
cool_barry = Image(screen, str(REPO_ROOT / 'images' / 'cool_barry.jpg'),
                   screen.width() / 3, screen.height() / 2, 150, 150)
